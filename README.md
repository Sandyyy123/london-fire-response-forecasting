...
**Difficulty:** 6/10 &middot; **Task type:** Time-series / Regression
...
```bash
git clone https://github.com/Sandyyy123/liora-04-london-fire-brigade.git
cd liora-04-london-fire-brigade
